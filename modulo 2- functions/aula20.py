...
print('#2 -',produtos_ordenados_por_nome, '\n')


produtos_ordenados_por_preco = copy.deepcopy(novos_produtos)
produtos_ordenados_por_preco.sort(key=lambda p:p['preco'], reverse=True)

print('#3 - ',produtos_ordenados_por_preco)
